                ...
                <?php else: ?>
                    <?php foreach ($laporan as $key => $item): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('admindetail/' . $item['id']) ?>" class="btn" style="padding: 0.5rem 1rem;">Detail</a>
                                <a href="#" onclick="openReportModalAdmin(<?= $item['id'] ?>)" class="btn btn-warning" style="padding: 0.5rem 1rem;">Verifikasi</a>
                            </td>
...
<form id="reportForm" action="<?= site_url('admin/laporan/verifikasi') ?>" method="post">
    ...
    <input type="hidden" name="laporan_id" id="laporan_id" value="">
            ...
            <div class="form-group">
                <label for="nama">Nama Admin Verifikasi *</label>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary" style="width: 100%">Simpan Verifikasi</button>
            </div>
        </form>
    </div>
</div>
